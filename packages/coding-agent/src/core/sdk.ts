...
import { Agent, type AgentMessage, type ThinkingLevel } from "@tobarrientos2/rho-agent-core";
import type { Message, Model } from "@tobarrientos2/rho-ai";
...
export interface CreateAgentSessionOptions {
	...
	cwd?: string;
	/** Global config directory. Default: ~/.rho/agent */
	agentDir?: string;
