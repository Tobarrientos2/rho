...
import { getModel, type OAuthCredentials, type OAuthProvider } from "@tobarrientos2/rho-ai";
import { getOAuthApiKey } from "@tobarrientos2/rho-ai/oauth";
...
// ============================================================================
// OAuth API key resolution from ~/.rho/agent/auth.json
// ============================================================================
...
/**
 * Resolve API key for a provider from ~/.rho/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.rho/agent/auth.json
 */
...
/**
 * Get an AuthStorage instance backed by ~/.rho/agent/auth.json
