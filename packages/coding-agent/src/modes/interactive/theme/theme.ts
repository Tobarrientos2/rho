...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@tobarrientos2/rho-tui";
...
const THEME_KEY = Symbol.for("@tobarrientos2/rho-coding-agent:theme");
...
export function getSettingsListTheme(): import("@tobarrientos2/rho-tui").SettingsListTheme {
	return {
