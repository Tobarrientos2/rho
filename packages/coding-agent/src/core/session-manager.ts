 ...
 * Encodes cwd into a safe directory name under ~/.rho/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.rho/agent/sessions/<encoded-cwd>/).
	 */
